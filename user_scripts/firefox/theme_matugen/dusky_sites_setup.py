#!/usr/bin/env python3
"""
🦊 Dusky Sites Setup Script (Modern Arch Linux / Python 3.12+)
============================================================
Automated setup script for Dusky Sites Native Messaging Host, Native UI,
and Arch Linux desktop application menu launcher synchronization.
