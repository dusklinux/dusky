...
SCHEMA = {
    ...
    4: [
        ...
        ConfigItem(label="Anchor", key="anchor", scope='app-name="Battery Monitor"', type_="cycle", default="center", options=["top-right", "top-center", "top-left", "bottom-right", "bottom-center", "bottom-left", "center-right", "center-left", "center"], parent_ref="menu_battery", extended_help="**Battery Anchor**\n\nWhere the battery overlay anchors on the screen (defaults to center)."),
        ConfigItem(label="Width", key="width", scope='app-name="Battery Monitor"', type_="int", default=360, min_val=100, max_val=800, step=10, parent_ref="menu_battery", extended_help="**Battery Width**\n\nTotal width of the battery notification overlay in pixels."),
        ConfigItem(label="Height", key="height", scope='app-name="Battery Monitor"', type_="int", default=110, min_val=50, max_val=400, step=5, parent_ref="menu_battery", extended_help="**Battery Height**\n\nTotal height of the battery notification overlay in pixels."),
        ConfigItem(label="Radius", key="border-radius", scope='app-name="Battery Monitor"', type_="int", default=16, min_val=0, max_val=50, step=1, parent_ref="menu_battery", extended_help="**Battery Corner Smoothing**\n\nRounded corners for the battery popup."),
        ...
        ConfigItem(label="MaxSize", key="max-icon-size", scope='app-name="Battery Monitor"', type_="int", default=64, min_val=16, max_val=128, step=4, parent_ref="menu_battery", extended_help="**Battery Icon Max Size**\n\nMaximum dimensions for the battery status icon."),
