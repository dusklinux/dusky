...
readonly SYMLINK_MAP=(
    ...
    "$HOME/user_scripts/dusky_system/control_center/service/com.github.veltraced.dusker.service | $HOME/.local/share/dbus-1/services/com.github.veltraced.dusker.service"
