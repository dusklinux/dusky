...
SCHEMA = {
    ...
    0: [
        ConfigItem(
            ...
            default="nil",
            group="Time & Date",
            extended_help="Enable or disable automatic network time synchronization via systemd-timesyncd (`timedatectl set-ntp true`).",
        ),
        ConfigItem(
            ...
            default="nil",
            group="Time & Date",
            extended_help="Configure real-time hardware clock to maintain local time vs UTC (`timedatectl set-local-rtc true/false`).",
        ),
        ConfigItem(
